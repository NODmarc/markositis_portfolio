...
class TextBoxPage(BasePage):
    ...
    def check_filled_form(self):
        full_name = \
        self.element_is_present(self.locators.CREATED_FULL_NAME).text.split(
            ':')[1]
        email = \
        self.element_is_present(self.locators.CREATED_EMAIL).text.split(':')[1]
...
class CheckBoxPage(BasePage):
    ...
    def get_output_result(self):
        result_list = self.element_are_present(self.locators.OUTPUT_RESULT_CHECKBOX)
        data = []
